    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="p-4 bg-white flex flex-col md:flex-row md:justify-between gap-4">
            <div class="relative w-full md:w-auto">
                ...
                <input type="text" id="table-search" class="block w-full md:w-72 lg:w-96 pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for items">
            </div>

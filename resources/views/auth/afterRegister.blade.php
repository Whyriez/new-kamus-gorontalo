        ...
        <div class="flex flex-col items-center">
            <div id="alert-5" class="flex items-center p-4 rounded-lg max-w-md bg-gray-50 dark:bg-gray-800 mb-3" role="alert">
                ...
                <div class="ms-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                    <p>Terimakasih telah mendaftar! 🫡😁 Register Berhasil, menunggu admin untuk aktivasi akun. </p>
                    <a href="{{ route('welcome') }}" class="font-semibold underline hover:no-underline">Kembali ke halaman login</a>
                </div>
